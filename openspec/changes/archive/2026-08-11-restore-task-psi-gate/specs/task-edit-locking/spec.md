...
An active task whose `psi_status` is `required` SHALL additionally block assignment planning operations without
making the task itself terminal or preventing allowed cleanup/status operations.
